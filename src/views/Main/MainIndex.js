					...
					<Col className="sm-6 lg-3">
						<Card>
							<CardBody className="clearfix p-0">
								...
								<h5 className="mb-0 text-primary pt-3"> $1,995.5</h5>
								<h5 className="text-muted text-uppercase font-weight-bold font-xs"> Total Income </h5>
								<h6 className="text-muted font-weight-bold font-xs">Recievables -> $0.00/$0.00</h6>
							</CardBody>
						</Card>
					</Col>
					<Col className="sm-6 lg-3">
						<Card>
							<CardBody className="clearfix p-0">
								...
								<h5 className="mb-0 text-primary pt-3"> $1,995.5</h5>
								<h5 className="text-muted text-uppercase font-weight-bold font-xs"> Total Expenses </h5>
								<h6 className="text-muted font-weight-bold font-xs">Payables -> $0.00/$0.00</h6>
							</CardBody>
						</Card>
					</Col>
					<Col className="sm-6 lg-3">
						<Card>
							<CardBody className="clearfix p-0">
								...
								<h5 className="mb-0 text-primary pt-3"> $1,995.5</h5>
								<h5 className="text-muted text-uppercase font-weight-bold font-xs"> Total Profit </h5>
								<h6 className="text-muted font-weight-bold font-xs">Upcoming -> $0.00/$0.00</h6>
							</CardBody>
						</Card>
					</Col>
				</Row>
