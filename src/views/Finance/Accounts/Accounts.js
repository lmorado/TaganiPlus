            ...
            {inputsData ? inputsData.map((data, i) => {
              ...
              return (
                <tr key={i}>
                  ...
                  <td>
                    <div className="responsive-label"> Number </div>
                    <div className="responsive-item text-right">{data.quantity}</div>
                  </td>
                  <td>
                    <div className="responsive-label"> Balance  </div>
  ...
  render() {
    ...
    return (
      <div className="animated fadeIn" style={{ minWidth: '450px' }}>
        <Card>
          <StyledCardHeader>
            <h5 style={{ paddingTop: 4}}> Accounts </h5>
          </StyledCardHeader>
          <CardBody>
            <Row>
                ...
                <div className="form-row responsive mobile-margin-bottom" style={{ marginLeft: 5, marginTop: 5}}>
                  <div>
                    <StyledButton className="ml-15" onClick={this.openModal}>
                      <i className="fa fa-plus-circle fa-lg hide" />  Add Account
                    </StyledButton>
                    <Popup
                      ...
                      <div className="animated fadeIn" style= {{height:"630px"}}>
                        <Card>
                          <StyledCardHeader>
                            ...
                            <h5 style={{ paddingTop: 4}}>Add Account</h5>
                          </StyledCardHeader>
                          <CardBody >
                            {showMsg && <Alert color="success"> Account successfully added. </Alert>}
                            <Col>
                            <Row>
